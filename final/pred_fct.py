...
# Fonction pour prédire la température à partir d'une date donnée
...
folder_path = "temperature_data"  # Assurez-vous que le chemin est correct

# Liste pour stocker les résultats
results = []

x_values = [6.606, 6.857,  6.158, 6.172, 6.337, 6.323, 6.54, 6.499, 6.66, 6.241, 6.476, 6.92, 6.241, 6.686, 6.851]  # Utiliser l'index comme valeur de 'x'
...
for i, file in enumerate(os.listdir(folder_path)):
    if file.endswith(".csv"):
        ...
        if 'date' in df_csv.columns:
            ...
            predicted_temp = predict_temperature("15/01/2025 14:00", model, poly)
